...
if active_page == "GIS Mapping":
    ...
    # The static server will expose the project folder at http://localhost:8000/
    map_url = f"http://localhost:8000/webmap_{year}/index.html"
    iframe_html = f'''
        <iframe src="{map_url}"
                style="width: 100%; height: 700px; border: none; border-radius: 16px; overflow: hidden;"
                loading="lazy">
        </iframe>
    '''
